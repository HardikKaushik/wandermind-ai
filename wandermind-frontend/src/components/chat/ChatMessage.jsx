      ...
      <div
        className={`max-w-[85%] ${
          isUser
            ...
            : 'bg-gray-100 text-gray-900 border border-gray-200 rounded-2xl rounded-tl-md'
        } px-4 py-3`}
      >
        {/* Text content */}
        ...
        {message.change_summary && (
          <div className="mt-2 flex items-center gap-1.5 px-2.5 py-1 rounded-full
                          bg-green-100 border border-green-300 w-fit">
            <span className="text-green-700 text-xs font-bold">Updated: {message.change_summary}</span>
          </div>
        )}
        ...
        {itinerary && itinerary.days && (
          <div className="mt-3 space-y-3">
            ...
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white border border-gray-200 text-xs">
              ...
              <span className="font-bold text-gray-700">{itinerary.destination}</span>
              <span className="text-gray-700">|</span>
            ...
            <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
              {itinerary.days.slice(0, 5).map((day) => (
                <div
                  key={day.day}
                  className="flex-shrink-0 w-40 rounded-lg overflow-hidden bg-white
                             border border-gray-200 hover:border-blue-400 hover:shadow-md transition-all cursor-pointer"
                ...
                >
                  ...
                  <div className="p-2">
                    ...
                    <p className="text-xs font-bold text-gray-800 truncate">{day.theme}</p>
                  </div>
                </div>
              ))}
            </div>
