...
export default function TypingIndicator() {
  ...
  return (
    <div className="flex items-start gap-3 animate-fade-in-up">
      ...
      <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-sm rounded-2xl rounded-tl-md px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-gray-500 dark:text-slate-400 ml-1 transition-opacity duration-300">
